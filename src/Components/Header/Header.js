...
const Header = () => {
  ...
  return (
    <>
        <div className='shadow-md bg-white z-30'>
            <div className='xl:container mx-auto px-12 lg:py-6 py-3 flex items-center justify-between'>
                <div className='flex items-center gap-x-10'>
                    ...
                    <nav className='lg:block hidden'>
                        <ul className='flex items-center gap-x-6 font-bold text-sm uppercase tracking-widest'>
                ...
                <div className='lg:flex hidden items-center gap-x-10'>
                    <a href="/" className='flex font-semibold text-sm gap-x-2 hover:text-hover-color'>
                        <MdLocationOn size={25}/>
                        Find a store
                    </a>
                    <div className='flex items-center gap-x-4'>
                        <a href="/" className='py-2 px-4 border border:[1px] border-gray-600 rounded-full leading-none text-sm font-semibold flex hover:bg-gray-100'>Sign in</a>
                        <a href="/" className='py-2 px-4 border border:[1px] border-gray-600 rounded-full leading-none text-sm font-semibold bg-black text-white hover:opacity-80'>Join now</a>
                    </div>
                </div>

                <div className='lg:hidden block cursor-pointer' onClick={toggleBurger}>
                    {
                        show ? <BsList size={25}/> : <IoMdClose size={25}/>
                    }
                </div>
            </div>
        </div>
        {
                    ...
                    <div className={`${show ? 'translate-x-[100%]' : 'translate-x-0'} bg-white w-3/4 absolute h-full right-0 px-8 py-10 top-[72px] z-20 menus`}>
                        <nav>
                            <ul className='flex flex-col gap-y-6 text-lg tracking-widest w-full'>
                                <li className='hover:text-hover-color flex cursor-pointer' onClick={toggleMenu}>
                                    <div className='w-full flex items-center justify-between mr-4'>Menu
                                    <IoIosArrowForward size={25}/>
                                    </div>
                                </li>
                                <li className='hover:text-hover-color w-full flex'>
                                    <a href="/" className='w-full'>Rewards</a>
                                </li>
                                <li className='hover:text-hover-color w-full flex'>
                        ...
                        <div className='my-8 bg-black opacity-20 w-full h-[1px]'></div>
                        <div className='flex flex-col gap-y-6'>
                            <div className='flex items-center'>
                                <a href="/" className='py-2 sm:px-4 px-3 mr-4 border border:[1px] border-gray-600 rounded-full leading-none text-sm font-semibold flex hover:bg-gray-100'>Sign in</a>
                                <a href="/" className='py-2 sm:px-4 px-3 border border:[1px] border-gray-600 rounded-full leading-none text-sm font-semibold bg-black text-white hover:opacity-80'>Join now</a>
                            </div>
                            <a href="/" className='flex font-semibold text-sm hover:text-hover-color'>
                                <MdLocationOn size={25}/>
                                Find a store
                            </a>
                        </div>
                            ...
                            <nav>
                                <ul className='flex flex-col gap-y-5'>
                                    <li className='w-full flex items-center bg-gray-50 py-4 cursor-pointer' onClick={toggleMenu}>
                                            <span className='pl-5'><IoIosArrowBack size={25}/></span>
                                            <div className='text-center w-4/5 text-lg tracking-wide'>Menu</div>
                                    </li>
                                    <li className='flex px-5 text-lg tracking-wide hover:text-hover-color'>
                                        <a href="/" className='w-full'>All Products</a>
                                    </li>
                                    <li className='flex px-5 text-lg tracking-wide hover:text-hover-color'>
                                        <a href="/" className='w-full'>Featured</a>
                                    </li>
                                    <li className='flex px-5 text-lg tracking-wide hover:text-hover-color'>
                                        <a href="/" className='w-full'>Previous Orders</a>
                                    </li>
                                    <li className='flex px-5 text-lg tracking-wide hover:text-hover-color'>
                                        <a href="/" className='w-full'>Favorite Products</a>
                                    </li>
                                </ul>
                            </nav>
                        </div>
        ...
        {
            windowWidth <= 1024 && 
            <div className={`${!show ? 'block' : 'hidden'} bg-black opacity-30 w-full h-full absolute top-[72px] z-10`} onClick={toggleBurger}></div>
        }
    </>
  )
}
